...
* __공헌 내용__ :
  ...
  * __전처리__ : XML (아파트별 소속지역 전처리, 지역코드, 아파트코드, 일일배출량)
  * __저장__ : csv,Json,xlsx (아파트별 소속지역 전처리, 지역코드, 아파트코드, 일일배출량)
...
* __개요__ :
 ...
  
* __공헌 내용__ :
  * __자료수집__ : 대선후보 페이스북 페이지([로또365 API](http://www.nlotto.co.kr/common.do?method=getLottoNumber)), 안철수페이스북(
  * __전처리 & 저장__ : 회차별 당첨번호, 진행회차, 당첨금액 (JSON)
  * __데이터 분석__ : 연관분석(Apriori), SVM, K-NN, 당첨확률
  
